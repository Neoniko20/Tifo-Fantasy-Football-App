...
export function ScoresView() {
  ...
  return (
    <div className="flex flex-col flex-1">
      {/* Date + league filter header */}
      <div className="sticky top-[96px] z-30" style={{ background: "var(--bg-page)", borderBottom: "1px solid var(--bg-elevated)" }}>
      ...
      {/* Content */}
      <div className="max-w-[480px] mx-auto w-full px-4 pt-3 pb-8">
        {loading ? (
